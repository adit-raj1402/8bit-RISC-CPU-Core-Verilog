...
![Performance and Power](reports/ppa%202%20.png.png)
...
![STA Summary](reports/ppa%201%20.png.png)

* **Setup Slack:** +4.420 ns (MET).
* **Hold Slack:** -0.130 ns (VIOLATED).

### 3. Area Analysis
![Area Breakdown](reports/ppa%203%20.png.png)
...
![Waveform Simulation](reports/waveform.png.png)
...
* **reports/**: High-resolution simulation and PPA reports.
